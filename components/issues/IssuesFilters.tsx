    ...
    return (
        <Card className="border-none shadow-sm bg-white">
            <CardContent className="p-4">
                <div className="flex flex-col md:flex-row flex-wrap gap-4 md:gap-6 items-start md:items-center">
                    {/* Status */}
                    ...
                    {/* Assignee */}
                    <div className="flex flex-col gap-1.5 w-full md:flex-1 md:min-w-[200px]">
                        <label className="text-xs font-semibold uppercase tracking-wider text-slate-500 flex items-center gap-1.5">
                        ...
                        <div className="relative">
                            ...
                            <Input
                                ...
                                className="pl-9 h-10 border-slate-200 focus-visible:ring-slate-400 bg-slate-50/50 w-full"
                                value={assignee}
                                onChange={(e) => {
                                    resetPage();
